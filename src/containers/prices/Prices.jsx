      ...
      <div className='wrapper section-padding'>
        <div className='prices'>
          ...
          <div className='price-cards'>
            <div className='price-card flex-box'  data-aos="fade-up" data-aos-duration="2000">
              <h3>Healthy</h3>
            ...
            <div className='price-card flex-box'  data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300" >
              <h3>Best Fit</h3>
              <div className='circle flex-box'>
                <p>$550</p>
              </div>
            ...
            <div className='price-card flex-box'  data-aos="fade-up" data-aos-duration="2000" data-aos-delay="600">
              <h3>Rigid Body</h3>
              <div className='circle flex-box'>
                <p>$750</p>
              </div>
